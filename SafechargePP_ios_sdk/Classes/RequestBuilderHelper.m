                                    ...
                                    andMethod:(E_SCH_CHECKSUM_METHODS) checksumMethod
{
    ...
    if ( checksumMethod == E_SCH_CHECKSUM_MD5 ) {
        return [RequestBuilderHelper MD5FromString:parametersString];
    } else if ( checksumMethod == E_SCH_CHECKSUM_SHA256 ) {
        return [RequestBuilderHelper SHA256FromString:parametersString];
    } else {
        SCHAssert(false);
        return nil;
    }
